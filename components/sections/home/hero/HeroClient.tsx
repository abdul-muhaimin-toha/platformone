...
export default function HeroClient({
  ...
  useGSAP(() => {
    ...
    const container = heroRef.current || document.body;
                ...
                return (
                  <div key={idx} className="flex flex-row items-center gap-x-4">
                    ...
                    <span
                      ...
                      className="h-2 w-[170px] md:hidden bg-linear-[90deg] rounded-[3px] from-pulse-pink-700/0 to-pulse-pink-700 scale-x-0"
                    />
                  </div>
                );
