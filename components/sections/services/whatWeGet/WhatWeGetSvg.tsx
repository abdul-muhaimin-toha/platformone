...
interface WhatWeGetSvgProps {
  className?: string;
}

const WhatWeGetSvg = forwardRef<SVGSVGElement, WhatWeGetSvgProps>(
  ({ className }, ref) => {
    return (
      <svg
        ref={ref}
...
WhatWeGetSvg.displayName = 'WhatWeGetSvg';

export default WhatWeGetSvg;
