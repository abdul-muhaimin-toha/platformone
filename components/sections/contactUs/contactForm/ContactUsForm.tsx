    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <Input
          ...
          {...register('firstName')}
          className={cn(
            'file:text-black placeholder:text-pulse-pink-600 selection:bg-background selection:text-black border-border h-10 rounded-xl shadow-none md:text-sm',
      ...
      <div className="flex flex-col gap-1 md:col-span-2">
        ...
        <Textarea
          {...register('message')}
          className={cn(
            'h-24 file:text-black placeholder:text-pulse-pink-600 selection:bg-background selection:text-black border-border rounded-xl shadow-none md:text-sm',
            'focus-visible:border focus-visible:ring-0'
          )}
        />
        <span className="text-red-500 text-xs ml-1">
