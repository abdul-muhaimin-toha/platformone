  ...
  return (
    <div className="w-full block">
      ...
      <blockquote className="w-full bg-pulse-pink-50 flex flex-col p-6 gap-6 mt-8 mb-16 first:mt-0 last:mb-0">
        ...
        <p className="text-base font-normal leading-[1.37] text-[#6C6C6C] first:mt-0 last:mb-0">
      ...
      <Image
        ...
        alt="Insight"
        className=" object-cover w-full rounded-2xl aspect-380/249 mt-8 mb-16 first:mt-0 last:mb-0"
        width={920}
        height={522}
      />
      <h3 className="text-[32px] leading-tight font-semibold text-black mt-16 mb-8 first:mt-0 last:mb-0">
      ...
      <div className="flex flex-row md:grid md:grid-cols-2 xl:grid-cols-3 items-center gap-6 overflow-auto pb-4 mt-8 grow-0 first:mt-0 last:mb-0">
